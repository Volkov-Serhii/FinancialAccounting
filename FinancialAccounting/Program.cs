...
//интеграци€ React приложени€ 
//builder.Services.AddSpaStaticFiles(configuration =>
//{
//    configuration.RootPath = "ClientApp/build"; // ѕуть к React приложению
//});
...
//    builder.UseSpa(spa =>
//    {
//        spa.Options.SourcePath = "ClientApp"; // ѕуть к React приложению

//        if (app.Environment.IsDevelopment())
//        {
//            spa.UseReactDevelopmentServer(npmScript: "start"); // «апустить React Development Server в режиме разработки
//        }
//    });
//});
...
//    builder.UseSpa(spa =>
//    {
//        spa.Options.SourcePath = "ClientApp"; // ѕуть к исходникам React приложени€
